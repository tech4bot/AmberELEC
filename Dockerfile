...
RUN apt update \
  && apt install -y \
    ...
    libvlc-dev libvlccore-dev vlc-bin texinfo golang libssl-dev curl patchelf \
    xmlstarlet patchutils gawk gperf default-jre python3 python-is-python3 xsltproc libjson-perl \
